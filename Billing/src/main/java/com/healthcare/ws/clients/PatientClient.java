...
public class PatientClient {
    public static List<String> getPatient() throws IOException, ParserConfigurationException, SAXException {
        ...
        Document document = getParsedOutput(xmlInput,"http://localhost:8088/wsdlfirst/patientService");
